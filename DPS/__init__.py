...
def create_app(test_config=None):
    ...
    def complexsignal():
        return render_template('complexsignal.html', Title="Sygnały zespolone", link1='sygnal',
                               link2='sygnaly-podstawowe')
    ...
    @app.route('/widmo')
    def spectrum():
        return render_template('spectrum.html', Title="Widmo sygnału", link1='dft',
                               link2='analiza-czestotliwosciowa-zadania')
